...
@WebServlet("/BrandModelsServlet")
public class BrandModelsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<ModelEntity> list = dao.getBrandModels(brand, (page - 1) * recordsPerPage, recordsPerPage);
		...
		request.setAttribute("brandModels", list);
		request.setAttribute("pages", pages);
		request.setAttribute("currentPage", page);
		RequestDispatcher view = request.getRequestDispatcher(IConstants.BRAND);
